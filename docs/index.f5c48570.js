...
/*Mobile menu */ /*GSAP */ var _gsap = require("gsap");
...
const articlesChildren = document.querySelector(".section__articles .container").children;
mm.add({
...
mm.add({
    ...
    (0, _gsap.gsap).fromTo(heroMockup, {
        opacity: 0,
        x: isDesktop ? 100 : 0,
        y: isDesktop ? 0 : -100
    }, {
...
(0, _gsap.gsap).fromTo(heroChildren, {
    opacity: 0,
    x: -100
}, {
    opacity: 1,
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["aJPIF","8ZNvh"], "8ZNvh", "parcelRequire716c")
